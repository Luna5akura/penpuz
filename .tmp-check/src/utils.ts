import type { FourWindsCellValue, FourWindsDirection, FourWindsPuzzleData } from './types.ts';
import type { NumberPlacementValidationResult } from './shared/NumberPlacementBoard.ts';
